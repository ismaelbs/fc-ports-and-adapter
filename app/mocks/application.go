...
import (
	...
	app "github.com/ismaelbs/fc-ports-and-adapter/app"
)
...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(p app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(p app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductWriter) Save(p app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(p app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", p)
	ret0, _ := ret[0].(app.ProductInterface)
	ret1, _ := ret[1].(error)
